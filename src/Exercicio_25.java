...
public class Exercicio_25 {
    public static void main(String[] args) {
        ...
        if (telefonouParaVitima == 's') {
            taxaDeRespostas = obterTaxaDeRespostas(taxaDeRespostas);
        ...
        } else if (taxaDeRespostas == 1 || taxaDeRespostas == 0) {
            System.out.print("Você esta liberado, inocente.");
        }
        scanner.close();
    }

    private static int obterTaxaDeRespostas(int taxaDeRespostas) {
        return taxaDeRespostas + 1;
    }
}
